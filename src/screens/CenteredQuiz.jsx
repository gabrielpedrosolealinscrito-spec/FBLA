...
// ┌─ STUB IMPORTS (Package 04) ───────────────────────────────────────────────┐
// │ Quiz-local stubs for unmerged contracts (packages 00 auth/tier/db, 03 a11y).│
// │ SWAP-ON-MERGE: repoint these to ../lib/auth, ../lib/tier, ../lib/db,        │
// │ ../lib/a11y when those land. Shapes already match README §1–3.              │
// └────────────────────────────────────────────────────────────────────────────┘
import {
  useAuth,
  useTier,
