...
// ═══════════════════════════════════════════════════════════════
// RESULTS MAP (night/gold standalone port) — interactive map of the
// matched US cities. Real state geometry via d3.geoAlbersUsa + us-atlas
// (states-albers-10m, served locally from /public). Pan/zoom, antique
// compass rose, engraved sea labels, gilded city markers, slide-in
// detail panel. SVG built imperatively with D3; chrome + panel are
// React. Reads engine-scored rows; onSelect(row) opens full city detail.
//
// NOTE: this is a sibling alternative to the satellite-terrain
// ResultsMap.jsx. Not wired into PotentialApp yet — pending the user's
// choice of which results-map design ships.
// ═══════════════════════════════════════════════════════════════
...
export default function ResultsMapNight({ results, profile, onSelect, onEdit }) {
