...
export const PORTUGAL_D8: VisaPathway = {
  ...
  pros: [
    'No Portuguese employer required, so remote income from non-PT clients qualifies',
...
export const CANADA_EXPRESS_ENTRY: VisaPathway = {
  ...
  cons: [
    ...
    'Language tests (IELTS/CELPIP) must be taken and results valid, with additional cost and timeline',
...
export const GENERIC_SKELETON: VisaPathway = {
  ...
  cons: [
    'Requirements, fees, and timelines vary, so verify at official source',
  ],
  documentChecklist: [
